...
class _LineChartAffirmativePolicyEvolutionState
        ...
        touchTooltipData: LineTouchTooltipData(
          ...
          getTooltipItems: (touchedBarSpots) {
            ...
            return touchedBarSpots.map((spot) {
                  ...
                  .firstWhere(
                    (entry) =>
                        ...
                        ColorsApp.getColorForIndex(
                                _getPolicyIndex(entry.key, data)) ==
                            spot.bar.color,
              ...
              final color =
                  ColorsApp.getColorForIndex(_getPolicyIndex(policy, data));
  ...
  List<LineChartBarData> _generateLineBars(
    ...
    return policyData.entries.map((entry) {
      final index = _getPolicyIndex(entry.key, data);
  ...
  int _getPolicyIndex(String policy, Data data) {
    final policies = data.affirmativePolicyDistribution.values
        .expand((map) => map.keys)
        .toSet()
        .toList();
    return policies.indexOf(policy);
  }
}
