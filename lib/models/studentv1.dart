...
class Studentv1 {
  ...
  factory Studentv1.fromMap(Map<String, dynamic> map) {
    return Studentv1(
  ...
  factory Studentv1.fromJson(String source) =>
      Studentv1.fromMap(json.decode(source) as Map<String, dynamic>);
  @override
  String toString() {
  ...
  @override
  bool operator ==(covariant Studentv1 other) {
